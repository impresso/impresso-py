...
from ...models.get_tr_clusters_facet_group_by import GetTrClustersFacetGroupBy
...
from ...models.get_tr_clusters_facet_range_include import GetTrClustersFacetRangeInclude
...
def _get_kwargs(
    ...
    *,
    ...
    range_include: Union[Unset, GetTrClustersFacetRangeInclude] = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        range_include (Union[Unset, GetTrClustersFacetRangeInclude]):
