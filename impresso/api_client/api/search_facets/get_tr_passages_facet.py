...
from ...models.get_tr_passages_facet_group_by import GetTrPassagesFacetGroupBy
from ...models.get_tr_passages_facet_id import GetTrPassagesFacetId
from ...models.get_tr_passages_facet_order_by import GetTrPassagesFacetOrderBy
from ...models.get_tr_passages_facet_range_include import GetTrPassagesFacetRangeInclude
from ...models.search_facet import SearchFacet
from ...types import UNSET, Response, Unset


def _get_kwargs(
    id: GetTrPassagesFacetId,
    *,
    order_by: Union[Unset, GetTrPassagesFacetOrderBy] = UNSET,
    group_by: Union[Unset, GetTrPassagesFacetGroupBy] = UNSET,
    ...
    range_include: Union[Unset, GetTrPassagesFacetRangeInclude] = UNSET,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/search-facets/tr-passages/{id}",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Get a single text reuse passages index facet

    Args:
        id (GetTrPassagesFacetId):
        order_by (Union[Unset, GetTrPassagesFacetOrderBy]):
        group_by (Union[Unset, GetTrPassagesFacetGroupBy]):
        filters (Union[Unset, List['Filter']]):
        range_start (Union[Unset, float]):
        range_end (Union[Unset, float]):
        range_gap (Union[Unset, float]):
        range_include (Union[Unset, GetTrPassagesFacetRangeInclude]):
