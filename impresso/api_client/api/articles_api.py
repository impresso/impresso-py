...
class ArticlesApi:
    ...
    def articles_get(
        self,
        resolve: Annotated[Optional[StrictStr], Field(description="TODO")] = None,
        order_by: Annotated[Optional[StrictStr], Field(description="Order by term")] = None,
        filters: Annotated[Optional[ArticlesGetFiltersParameter], Field(description="Filters to apply")] = None,
        ...
        :type filters: ArticlesGetFiltersParameter
        ...
        _param = self._articles_get_serialize(
            resolve=resolve,
            order_by=order_by,
            filters=filters,
            limit=limit,
    ...
    @validate_call
    def articles_get_with_http_info(
        self,
        resolve: Annotated[Optional[StrictStr], Field(description="TODO")] = None,
        order_by: Annotated[Optional[StrictStr], Field(description="Order by term")] = None,
        filters: Annotated[Optional[ArticlesGetFiltersParameter], Field(description="Filters to apply")] = None,
    ...
    @validate_call
    def articles_get_without_preload_content(
        self,
        resolve: Annotated[Optional[StrictStr], Field(description="TODO")] = None,
        order_by: Annotated[Optional[StrictStr], Field(description="Order by term")] = None,
        filters: Annotated[Optional[ArticlesGetFiltersParameter], Field(description="Filters to apply")] = None,
    ...
    def articles_id_get(
        self,
        id: Annotated[StrictInt, Field(description="ID of articles to return")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: ID of articles to return (required)
        :type id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._articles_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def articles_id_get_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="ID of articles to return")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def articles_id_get_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="ID of articles to return")],
        _request_timeout: Union[
            None,
    ...
    def _articles_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
