...
if TYPE_CHECKING:
    ...
    from ..models.get_search_response_200_info import GetSearchResponse200Info
...
class GetSearchResponse200:
    ...
    Attributes:
        ...
        info (GetSearchResponse200Info): Additional information about the response.
        data (List['Article']):
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        info = GetSearchResponse200Info.from_dict(d.pop("info"))
