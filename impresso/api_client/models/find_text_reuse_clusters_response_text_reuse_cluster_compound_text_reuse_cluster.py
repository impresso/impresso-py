...
if TYPE_CHECKING:
    from ..models.find_text_reuse_clusters_response_text_reuse_cluster_compound_text_reuse_cluster_time_coverage import (
        FindTextReuseClustersResponseTextReuseClusterCompoundTextReuseClusterTimeCoverage,
    )


T = TypeVar("T", bound="FindTextReuseClustersResponseTextReuseClusterCompoundTextReuseCluster")


@_attrs_define
class FindTextReuseClustersResponseTextReuseClusterCompoundTextReuseCluster:
    ...
    Attributes:
        ...
        time_coverage (Union[Unset, FindTextReuseClustersResponseTextReuseClusterCompoundTextReuseClusterTimeCoverage]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_time_coverage, Unset):
            ...
            time_coverage = FindTextReuseClustersResponseTextReuseClusterCompoundTextReuseClusterTimeCoverage.from_dict(
                _time_coverage
            )

        find_text_reuse_clusters_response_text_reuse_cluster_compound_text_reuse_cluster = cls(
            id=id,
        ...
        return find_text_reuse_clusters_response_text_reuse_cluster_compound_text_reuse_cluster
