...
class AuthResponseSchema(BaseModel):
    ...
    authentication: AuthResponseSchemaAuthentication
    user: User
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "authentication": AuthResponseSchemaAuthentication.from_dict(obj["authentication"]) if obj.get("authentication") is not None else None,
